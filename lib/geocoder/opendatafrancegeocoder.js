        ...
        if (err) {
            ...
            if (result.features) {
              for (var i = 0; i < result.features.length; i++) {
                var formatedResult = _this._formatResult(result.features[i]);
                if (result.features[i].properties.score) {
                  formatedResult.confidence = result.features[i].properties.score;
                }        
